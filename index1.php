...
<?php
							...
							$password=$_POST['password'];
								...
								$result = mysql_query("SELECT * FROM users WHERE department like '%TEACHER%' and username ='$username' AND password = '$password'") or die(mysql_error());
